...
def return_(movement_id: int, payload: s.FileReturnUpdate | None = None, db: Session = Depends(get_db)):
...
def list_(skip: int = 0, limit: int = 50, outstanding: bool | None = None, file_no: str | None = None, db: Session = Depends(get_db)):
