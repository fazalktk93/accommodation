...
import { getHouseByFile, listAllotmentHistoryByFile, createAllotment } from '../api'
...
export default function HouseAllotmentsPage(){
  ...
  return (
    <div>
      <h2>House — Allotment History</h2>
      {error && <div className="error">{error}</div>}
      {loading && <div>Loading…</div>}

      {house && (
        <div className="card" style={{marginBottom:'1rem'}}>
          <strong>File No:</strong> {house.file_no} &nbsp; | &nbsp;
          <strong>Qtr:</strong> {house.qtr_no} &nbsp; | &nbsp;
          <strong>Street:</strong> {house.street} &nbsp; | &nbsp;
          <strong>Sector:</strong> {house.sector} &nbsp; | &nbsp;
          <strong>Type:</strong> {house.type_code} &nbsp; | &nbsp;
